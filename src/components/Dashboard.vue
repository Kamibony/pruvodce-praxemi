...
const school = computed(() => {
  return db.schools[props.user.schoolId];
});

const team = computed(() => {
  return db.students.filter(s => s.schoolId === props.user.schoolId && s.id !== props.user.id);
});
...
<template>
  <div class="min-h-screen bg-gray-50 flex flex-col font-sans">
    ...
    <main class="flex-grow container mx-auto px-4 py-8 space-y-8 max-w-4xl">
      ...
      <!-- My School Card -->
      <section class="bg-white rounded-xl shadow-md overflow-hidden border-t-4 border-blue-600 transition hover:shadow-lg">
        <div class="p-6">
      ...
      <!-- My Team Card -->
      <section class="bg-white rounded-xl shadow-md p-6 transition hover:shadow-lg">
        <h3 class="text-xl font-semibold text-gray-800 mb-6 flex items-center">
      ...
      <section class="bg-white rounded-xl shadow-md p-6">
        ...
        <div class="space-y-3">
          <div v-for="(item, index) in db.faq" :key="index" class="border border-gray-200 rounded-lg overflow-hidden">
            <button
